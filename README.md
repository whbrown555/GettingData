#*Modified HAR Dataset derived from:*
...
*This dataset takes the average feature value for the mean and standard deviation metrics associated with each activity and subject.*
...
##*For each record in this modified dataset it is provided:*
> > - Triaxial acceleration from the accelerometer (total acceleration) and the estimated body acceleration.
> > - Triaxial Angular velocity from the gyroscope. 
- *An 86-feature vector with time and frequency domain variables, merged with each associated activity and the subject who carried out the experiment.*

##*The dataset includes the following files:*
- *'README.md' (this file)*
- *'CodeBook.md': Shows information about the variables used on the feature vector.*
- *'UCI_HAR_Avg_FeatureMeanStd.csv'* 
